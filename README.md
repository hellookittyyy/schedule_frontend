...
**Переглянути розклад:**
[https://hellookittyyy.github.io/schedule_frontend/](https://hellookittyyy.github.io/schedule_frontend/)
...
Для повноцінної роботи потребується запущена бекенд-частина для отримання та оновлення даних.
